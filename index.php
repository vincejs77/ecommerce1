                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div class="relative flex flex-col w-full gap-4 sm:flex-row">
                                                ...
                                                <button
                                                    class="px-6 py-3.5 font-semibold bg-blue-500 text-lg text-white rounded-md">Get
                                                    Started</button>
                                            </div>
                                        </div>
                                                        ...
                                                        <div class="relative h-full p-5 bg-white border-2 border-indigo-500 rounded-lg"
                                                            ...
                                                            <div class="flex items-center -mt-1">
                                                                ...
                                                                <h3 class="my-2 ml-3 text-lg font-bold text-gray-800">
                                                                    Awesome Dashboard</h3>
                                                            </div>
                                                            <p class="mt-3 mb-1 text-xs font-medium text-indigo-500 uppercase"
                                                                data-primary="indigo-500">PREMIUM FEATURE</p>
                                                            <p class="mb-2 text-gray-600">You can get a quick snapshot
                                                                of all your analytics on your beautiful dashboard.</p>
                                                        </div>
                                                ...
                                                <div class="w-full sm:w-1/2">
                                                    <div class="relative h-full ml-0 md:mr-10">
                                                        ...
                                                        <div class="relative h-full p-5 bg-white border-2 border-purple-500 rounded-lg"
                                                            ...
                                                            <p class="mb-2 text-gray-600">We've got some pretty rad
                                                                tools to help you take on the world.</p>
                                                        </div>
                                                    ...
                                                    <div class="relative h-full ml-0 mr-0 sm:mr-10">
                                                        ...
                                                        <div class="relative h-full p-5 bg-white border-2 border-blue-400 rounded-lg"
                                                            ...
                                                            <div class="flex items-center -mt-1">
                                                                ...
                                                                <h3 class="my-2 ml-3 text-lg font-bold text-gray-800">
                                                                    Easy Collaboration</h3>
                                                            </div>
                                                            <p class="mt-3 mb-1 text-xs font-medium text-blue-400 uppercase"
                                                                data-primary="blue-400">FREE FEATURE</p>
                                                            <p class="mb-2 text-gray-600">Collaborating with members of
                                                                your team couldn't be easier.</p>
                                                        </div>
                                                    ...
                                                    <div class="relative h-full ml-0 md:mr-10">
                                                        ...
                                                        <div class="relative h-full p-5 bg-white border-2 border-green-500 rounded-lg"
                                                            ...
                                                            <div class="flex items-center -mt-1">
                                                                ...
                                                                <h3 class="my-2 ml-3 text-lg font-bold text-gray-800">
                                                                    Automated Workflow</h3>
                                                            </div>
                                                            <p class="mt-3 mb-1 text-xs font-medium text-green-500 uppercase"
                                                                data-primary="green-500">PREMIUM FEATURE</p>
                                                            <p class="mb-2 text-gray-600">Our automation tools will help
                                                                you build and grow your marketing empire.</p>
                                                        </div>
