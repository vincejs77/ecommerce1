                    ...
                    <div class="row">
                        <div class="col-sm-9">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <form class="form-inline" id="productForm">
                                        <div class="form-group">
                                            ...
                                            <button type="submit" class="btn btn-primary bg-blue-900 btn-lg btn-flat"><i
                            ...
                            <div class="fb-comments"
                                data-href="http://localhost/ecommerce3/ecommerce/product.php?product=<?php echo $slug; ?>"
