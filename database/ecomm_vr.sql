...
--
-- Hôte : localhost
-- Généré le : sam. 07 jan. 2023 à 16:38
...
(1, 'Laptops', 'laptops'),
(2, 'Odinateur de bureau', 'desktop-pc'),
(3, 'Tablettes', 'tablets'),
...
(11, 9, 'PAYID-MNRI3TI4FH86744HC291472U', '2022-11-02'),
(12, 9, 'PAYID-MNRJIQA7GV92753E1193171H', '2022-11-02');
...
CREATE TABLE `users` (
  ...
  `activate_code` varchar(15) NOT NULL DEFAULT '1234',
  `reset_code` varchar(15) NOT NULL DEFAULT '1234',
...
(1, 'admin@admin.com', '$2y$10$0SHFfoWzz8WZpdu9Qw//E.tWamILbiNCX7bqhy3od0gvK5.kSJ8N2', 1, 'Admin', 'Alpha', '', '', '304858095_513852123937504_3416850235079982028_n.jpg', 1, '', '', '2022-10-11'),
(9, 'bin98@gmail.com', '$2y$10$Oongyx.Rv0Y/vbHGOxywl.qf18bXFiZOcEaI4ZpRRLzFNGKAhObSC', 0, 'Bin', 'Ndaygoma', 'Bukavu, AV.  Nyofu', '09092735719', '304858095_513852123937504_3416850235079982028_n.jpg', 1, 'k8FBpynQfqsv', 'wzPGkX5IODlTYHg', '2022-10-11');
